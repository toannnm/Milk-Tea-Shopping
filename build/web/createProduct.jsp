        ...
        <section>
            <form action="MainController" method="POST">
                <div class="formmer">
                    ...
                    <select name="categoryID" placeholder="Product CategoryID" >
                        <option value="A">A<%= producterror.getCategoryID()%>
                        </option>
                        <option value="B">B<%= producterror.getCategoryID()%>
                        </option>
                        <option value="C">C<%= producterror.getCategoryID()%>
                        </option>
                    </select>
